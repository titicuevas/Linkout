...
export default function Home() {
  ...
  return (
    <Layout showNavbar={false}>
      <div className="flex flex-1 flex-col items-center justify-center w-full min-h-screen bg-gradient-to-br from-blue-800 via-indigo-900 to-purple-900" style={{fontFamily: 'Poppins, Arial, sans-serif'}}>
        <img src={logo} alt="Logo Linkout" className="w-32 h-32 mb-8 rounded-full shadow-2xl bg-white border-4 border-white object-contain" />
        ...
        <Link
          to="/login"
          className="px-10 py-4 bg-gradient-to-r from-blue-600 via-indigo-500 to-pink-500 hover:from-pink-500 hover:to-blue-600 text-white rounded-full shadow-2xl transition-all duration-300 font-extrabold text-xl border-2 border-white outline-none focus:ring-4 focus:ring-pink-200 text-center drop-shadow-lg tracking-wide"
        >
