...
export default function Home() {
  ...
  return (
    <Layout showNavbar={false}>
      <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-800 via-indigo-900 to-purple-900" style={{fontFamily: 'Poppins, Arial, sans-serif'}}>
        <img src={logo} alt="Logo Linkout" className="w-32 h-32 mb-8 rounded-full shadow-2xl bg-white border-4 border-white" style={{marginTop: '2rem'}} />
